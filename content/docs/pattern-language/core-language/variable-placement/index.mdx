...
<DocumentedImage src="/assets/pattern-language/core-language/variable-placement/placement-data.png" alt="Screenshot" />

<DocumentedImage src="/assets/pattern-language/core-language/variable-placement/placement-hex.png" alt="Screenshot" />
