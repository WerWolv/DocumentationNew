...
Refer to [the endianness pragma](/pattern-language/core-language/preprocessor#endian) for setting the global endianness.
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/enums-data.png" alt="Screenshot" />
...
It's specially useful to combine it with the [break statement](/pattern-language/core-language/control-flow#break):
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/pointers-data.png" alt="Screenshot" />

<DocumentedImage src="/assets/pattern-language/core-language/data-types/pointers-hex.png" alt="Screenshot" />
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/bitfields-data.png" alt="Screenshot" />
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/structs-data.png" alt="Screenshot" />

<DocumentedImage src="/assets/pattern-language/core-language/data-types/structs-hex.png" alt="Screenshot" />
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/padding.png" alt="Screenshot" />
...
The pattern language provides advanced features that allow for much more complex struct definitions, these features are detailed on the [Control Flow](/pattern-language/core-language/control-flow) page.
...
<DocumentedImage src="/assets/pattern-language/core-language/data-types/unions-data.png" alt="Screenshot" />

<DocumentedImage src="/assets/pattern-language/core-language/data-types/unions-hex.png" alt="Screenshot" />
...
If you want them to show up, you need to use the [export attribute](/pattern-language/core-language/attributes#export):
