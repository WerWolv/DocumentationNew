---
title: "Expressions"
description: "Documentation for Expressions."
published: true
toc:
  visible: true
---
...
| `a ? b : c`   | Ternary                                                                       |
| `(a)`         | Parenthesis                                                                   |
| `function(a)` | [Function](/pattern-language/core-language/functions) call |
...
You can store it in a [global variable](/pattern-language/core-language/variable-placement#global-variables) and access it later:
