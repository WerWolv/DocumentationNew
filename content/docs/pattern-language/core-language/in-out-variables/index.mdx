---
title: "In / Out Variables"
description: "Documentation for In / Out Variables."
published: true
toc:
  visible: true
---
...
<DocumentedImage src="/assets/pattern-language/core-language/in-out-variables/settings.png" alt="Screenshot" />
