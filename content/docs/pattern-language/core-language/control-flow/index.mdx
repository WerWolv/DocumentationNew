---
title: "Control flow"
description: "Documentation for Control flow."
published: true
toc:
  visible: true
---
...
<DocumentedImage src="/assets/pattern-language/core-language/control-flow/conditionals-data.png" alt="Screenshot" />

<DocumentedImage src="/assets/pattern-language/core-language/control-flow/conditionals-hex.png" alt="Screenshot" />
...
This can for instance be used in combination with [In/Out Variables](/pattern-language/core-language/in-out-variables) to easily filter array items.
