...
toc:
  visible: true
---
<DocumentedImage src="/assets/imhex/views/bookmarks/overview.png" alt="The Bookmarks View" caption="The Bookmarks View" />
...
<DocumentedImage src="/assets/imhex/views/bookmarks/color-picker.png" alt="Bookmark color picker" caption="Bookmark color picker" />
...
<DocumentedImage src="/assets/imhex/views/bookmarks/hover-popup.png" alt="Hover popup" caption="Hover popup" />

### Bookmark actions

<DocumentedImage src="/assets/imhex/views/bookmarks/actions.png" alt="Available options" caption="Available options" />
