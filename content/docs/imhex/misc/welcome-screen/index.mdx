...
toc:
  visible: true
---
<DocumentedImage src="/assets/imhex/misc/welcome-screen/overview.png" alt="The Welcome Screen" caption="The Welcome Screen" />
...
| ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| ![Simplified Welcome Screen](/assets/imhex/misc/welcome-screen/simplified.png) | ![Simplified Editor Mode](/assets/imhex/misc/welcome-screen/edit-screen-simplified.png) |
