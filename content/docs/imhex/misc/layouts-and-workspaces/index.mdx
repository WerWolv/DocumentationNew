...
description: "Documentation for Layouts and Workspaces."
published: true
toc:
  visible: true
---
...
<DocumentedImage src="/assets/imhex/misc/layouts-and-workspaces/workspace-menu.png" alt="Workspace menu" caption="Workspace menu" />
