---
title: "Fonts"
description: "Documentation for Fonts."
published: true
toc:
  visible: true
---
...
<DocumentedImage src="/assets/imhex/common/fonts/settings.png" alt="A cutom font being selected in the Settings interface" caption="A cutom font being selected in the Settings interface" />
