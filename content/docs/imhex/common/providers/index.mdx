...
<DocumentedImage src="/assets/imhex/common/providers/list.png" alt="Other providers" caption="Other providers" />
...
<DocumentedImage src="/assets/imhex/common/providers/process-memory.png" alt="Process Memory Provider configuration popup" caption="Process Memory Provider configuration popup" />
